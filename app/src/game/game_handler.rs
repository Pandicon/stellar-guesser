...
impl GameHandler {
    ...
    pub fn next_question(&mut self, cellestial_sphere: &mut crate::rendering::caspr::renderer::CellestialSphere, sky: &mut sky::Sky, theme: &Theme, actions: &mut Vec<Action>) {
